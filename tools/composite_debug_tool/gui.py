...
class App(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("Composite Debug Tool")
    ...
    def _build_footer(self):
        footer = ttk.Label(self, text="© 2026 duonghao.dev", foreground="gray", font=("Segoe UI", 8))
        footer.grid(row=1, column=0, columnspan=2, pady=(0, 4))
